 ...
 * Media
 *
 * @ORM\Table(name="media", uniqueConstraints={@ORM\UniqueConstraint(name="unique_id", columns={"id"})})
 * @ORM\Entity(repositoryClass="Api\Repository\MediaRepository")
 */
class Media
{
    /**
     ...
     * @var integer
     *
     * @ORM\Column(name="category_id", type="bigint", precision=0, scale=0, nullable=true, unique=false)
     */
    private $categoryId;
     ...
     * @var string
     *
     * @ORM\Column(name="s_content", type="text", length=16777215, precision=0, scale=0, nullable=true, unique=false)
     */
    private $sContent;
     ...
     * @var integer
     *
     * @ORM\Column(name="section_site_id", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var MediaCategories
     *
     * @ORM\ManyToOne(targetEntity="Api\Entity\MediaCategories", inversedBy="mediaPosts")
     * @ORM\JoinColumns({
     ...
     * Set sectionSiteId
     *
     * @param integer $sectionSiteId
     *
     * @return Media
     */
    public function setSectionSiteId($sectionSiteId)
    {
    ...
    /**
     * @param MediaCategories $mediaCategory
     */
