 ...
 * Manufacture
 *
 * @ORM\Table(name="manufacture", uniqueConstraints={@ORM\UniqueConstraint(name="unique_id", columns={"id"}), @ORM\UniqueConstraint(name="unique_full_path", columns={"full_path"})})
 * @ORM\Entity
 */
class Manufacture
{
