...
class Slugify
{
    ...
    public function filter($string)
    {
        ...
        $string = strtolower(strtr($string, $this->_rules));
        $string = preg_replace($this->_regExp, $separator, $string);
    ...
    {
        return $this->_regExp = self::LOWERCASE_NUMBERS_DASHES;
    }
