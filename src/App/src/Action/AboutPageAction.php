...
class AboutPageAction implements ServerMiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, DelegateInterface $delegate)
    {
        ...
        return new HtmlResponse($this->templateRenderer->render('app::about-page', $data));
        //return new JsonResponse([$page->getTitle() => $page->getPath()]);
    }
}